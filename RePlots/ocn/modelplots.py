...
class ModelPlots(OceanDiagnostic):
    """model vs. observations ocean diagnostics setup
    """
    def __init__(self):
        """ initialize
        """
        super(ModelPlots, self).__init__()

        self._name = 'MODEL_PLOTS'
        self._title = 'Model'
    ...
    def check_prerequisites(self, env):
        ...
        super(ModelPlots, self).check_prerequisites(env)
    ...
    def run_diagnostics(self, env):
        ...
        """
        super(ModelPlots, self).run_diagnostics(env)
